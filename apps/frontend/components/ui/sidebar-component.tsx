      ...
      sections: [
        {
          title: "Workspace",
          items: [
            { icon: <SettingsIcon size={16} className="text-[var(--foreground)]" />, label: "Business Profile", href: "/settings?tab=profile" },
    ...
    <>
      ...
      <aside
        className={`bg-[var(--background)] flex flex-col gap-4 items-start p-4 transition-all duration-300 h-screen border-r border-[var(--surface-border)]
          ...
          ${isCollapsed ? "lg:w-20 lg:min-w-20 lg:!px-0 lg:justify-center" : "lg:w-72"}
        `}
        style={{ transitionTimingFunction: softSpringEasing }}
      >
        <button
